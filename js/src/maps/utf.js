...
ilib.Charmap.UTF8.prototype = new ilib.Charmap();
ilib.Charmap.UTF8.prototype.parent = ilib.Charmap;
ilib.Charmap.UTF8.prototype.constructor = ilib.Charmap.UTF8;

ilib.Charmap.UTF8.prototype.validate = function(bytes) {
	var i = 0;
...
ilib.Charmap.UTF8.prototype.mapToUnicode = function (bytes) {
...
ilib.Charmap.UTF8.prototype.mapToNative = function(str) {
	if (typeof(Buffer) !== "undefined") {
		// nodejs can convert it quickly in native code
...
ilib.Charmap.UTF16LE.prototype = new ilib.Charmap();
ilib.Charmap.UTF16LE.prototype.parent = ilib.Charmap;
ilib.Charmap.UTF16LE.prototype.constructor = ilib.Charmap.UTF16LE;

ilib.Charmap.UTF16LE.prototype.mapToUnicode = function (bytes) {
	if (typeof(Buffer) !== "undefined") {
		// nodejs can convert it quickly in native code
		var b = new Buffer(bytes);
...
ilib.Charmap.UTF16LE.prototype.mapToNative =  function(str) {
	if (typeof(Buffer) !== "undefined") {
		// nodejs can convert it quickly in native code
...
ilib.Charmap.UTF16BE.prototype = new ilib.Charmap();
ilib.Charmap.UTF16BE.prototype.parent = ilib.Charmap;
ilib.Charmap.UTF16BE.prototype.constructor = ilib.Charmap.UTF16BE;

ilib.Charmap.UTF16BE.prototype.mapToUnicode = function (bytes) {
...
ilib.Charmap.UTF16BE.prototype.mapToNative = function(str) {
	// nodejs can't convert big-endian in native code,
	// so we would have to flip each Uint16 ourselves.
	// At that point, it's just quicker to convert 
	// in JS code anyways
